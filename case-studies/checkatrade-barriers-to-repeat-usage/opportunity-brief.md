# Opportunity Brief — Checkatrade: Barriers to repeat usage

*A real end-to-end run of the Opportunity Workflow (July 2026): a first-hand walked journey → [populated canvas](opportunity-canvas.md) → this brief, produced against a live, time-boxed product challenge on a business I'd just used as a customer. Researched via the [Researcher Workflow](../../workflows/researcher/) (Companies House filings, pricing pages — see [`research/`](research/)). Author: Taimur Ahmed · Contributor: Claude, driven by this repo's prompts · Date: 5 July 2026 · Time-box: 90 minutes.*
