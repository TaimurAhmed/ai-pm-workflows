<!--
Canvas schema — the single source of truth for section order, titles, and tips.
...
Section numbers are a suggested path, NOT a protocol — see ground rules.
The Miro board layout for this schema lives in opportunity-canvas.miro.json.
-->
