---
description: "Show the AI PM Workflows menu"
---

Show the user this menu, verbatim, in their language — then stop and wait:
...
>
> 📎 *See a real end-to-end run: `workflows/opportunity/examples/checkatrade-repeat-usage.md`. Mid-session factual unknowns? I can dispatch research (company filings, pricing) without breaking your flow.*
>
> New here? Start with `/generate` followed by your canvas title.
